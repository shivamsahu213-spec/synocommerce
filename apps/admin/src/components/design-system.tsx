...
export interface AppLayoutProps {
  activeTab: 'dashboard' | 'products' | 'orders' | 'customers' | 'inventory' | 'analytics' | 'low-code' | 'migration' | 'search';
  title: string;
      ...
      <aside style={{ width: '260px', backgroundColor: '#111827', borderRight: '1px solid #1F2937', padding: '1.5rem', display: 'flex', flexDirection: 'column' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '2rem' }}>
          ...
          <div>
            ...
            <div style={{ fontSize: '0.75rem', color: '#9CA3AF' }}>Inventory Studio</div>
          </div>
        </div>
        ...
        <nav style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', flex: 1 }}>
          ...
          <a href="/customers" style={{ padding: '0.75rem 1rem', borderRadius: '6px', color: '#9CA3AF', textDecoration: 'none' }}>
            👥 Customers & LTV
          </a>
          <a
            href="/inventory"
